...
aws emr create-cluster \
    ...
    --steps '[{"Args":["spark-submit","--deploy-mode","cluster","s3://tinysearch/code/extract.py","--py-files","s3://tinysearch/code/sparkcc.py"],"Type":"CUSTOM_JAR","ActionOnFailure":"CONTINUE","Jar":"command-runner.jar","Properties":"","Name":"Spark application"}]' \
    --name 'TinySearch' \
