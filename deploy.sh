...
aws emr create-cluster \
    ...
    --steps '[{"Args":["spark-submit","--deploy-mode","cluster","s3n://tinysearch/code/extract.py","--files","s3://tinysearch/code/hn-top-domains-filtered.json"],"Type":"CUSTOM_JAR","ActionOnFailure":"CONTINUE","Jar":"command-runner.jar","Properties":"","Name":"Spark application"}]' \
    --name 'TinySearch' \
